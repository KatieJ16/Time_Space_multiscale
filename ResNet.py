...
from utils_single_list import DataSet
...
class ResNet(torch.nn.Module):
    ...
    def forward(self, x_init):
        ...
        print("self._modules['increment'](x_init) = ", self._modules['increment'](x_init).shape)
...
#         self.check_data_info(dataset)
        ...
        while epoch < max_epoch:
            ...
            print("train_x.shape = ", dataset.train_x.shape)
            ...
            val_loss = self.calculate_loss(dataset.val_x.T, dataset.val_ys.T, w=w)
            # ================ early stopping =================
            if best_loss <= 1e-8:
